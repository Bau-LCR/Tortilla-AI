document.addEventListener("DOMContentLoaded", () => {
    ...
    // ===== CANVAS PARA NODOS Y CONEXIONES =====
    ...
    // Nodos flotantes con conexiones entre sí
    ...
    // Ondas expansivas (círculos que se dilatan y desvanecen)
    const waves = [];
    function spawnWave() {
        if (waves.length < 5) {
            waves.push({
    ...
    function draw() {
        ...
        for (const node of NODES) {
            ...
            // Dibujar nodo como gradiente radial
