...
const SANDBOX_AGENT_BUILD = "gemini-interactions-lowpoly-20260822-5011";
...
async function handleSandboxRequest(req, res) {
    ...
    try {
        const result = await callWorkspaceModel({
            ...
            ...(directLowPolyRequest ? { reasoning: { effort: "none", exclude: true }, transport: "gemini-interactions" } : {}),
        });
