...
(function () {
  ...
  function bind() { $('cr-project-close')?.addEventListener('click', close); $('cutreal-project-create')?.addEventListener('click', create); $('cr-project-run')?.addEventListener('click', run); $('cr-project-send')?.addEventListener('click', send); $('cr-project-delete-current')?.addEventListener('click', () => remove()); $('cr-project-share')?.addEventListener('click', shareProject); $('cr-project-import')?.addEventListener('click', importProject); $('cr-project-save-secret')?.addEventListener('click', saveSecret); $('cr-project-reveal-secret')?.addEventListener('click', revealSecret); $('cr-project-new-file')?.addEventListener('click', createFile); $('cr-project-rename-file')?.addEventListener('click', renameFile); $('cr-project-delete-file')?.addEventListener('click', deleteFile); $('cr-project-fullscreen')?.addEventListener('click', toggleFullscreen); $('cr-project-editor-expand')?.addEventListener('click', () => toggleProjectPanel('cr-project-editor-shell', 'cr-project-editor-expand')); $('cr-project-preview-expand')?.addEventListener('click', () => toggleProjectPanel('cr-project-preview-shell', 'cr-project-preview-expand')); $('cr-project-model')?.addEventListener('change', event => { const project = active(); if (project) { project.model = event.target.value; save(); renderList(); } }); $('cr-project-new-file-name')?.addEventListener('keydown', e => { if (e.key === 'Enter') { e.preventDefault(); createFile(); } }); $('cr-project-input')?.addEventListener('keydown', e => { if (e.key === 'Enter' && !e.shiftKey) { e.preventDefault(); send(); } }); }
