...
(function () {
  ...
  function renderEditor() {
    ...
    editor.value = project.files[project.activeFile] || '';
    let checkpoint;
    editor.oninput = () => { project.files[project.activeFile] = editor.value; save(); clearTimeout(checkpoint); checkpoint = setTimeout(() => { recordVersion(project, `Edición manual de ${project.activeFile}`); save(); setStatus(`Guardado · ${project.activeFile}`); }, 700); };
  }
  function renderChat() {
